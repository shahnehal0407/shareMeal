...
import com.nehal.myfirstapp.Reciver.ReceiverHomeActivity;
import com.nehal.myfirstapp.Reciver.SignupActivity;
import com.nehal.myfirstapp.ngo.NgoHomeActivity;
import com.nehal.myfirstapp.ngo.NgoRegisterActivity;
    ...
    private void check(String uid) {
        ...
        df.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if (documentSnapshot.getString("isNgo") !=null){

                    SharedPreferences.Editor editor = user_session.edit();
                    editor.putString("cu_type", "Ngo");
                    editor.putBoolean("isLoggedIn",true);

                    editor.commit();
                    Toast.makeText(LoginActivity.this, " Ngo Logged in Successfully", Toast.LENGTH_SHORT).show();

                    startActivity(new Intent(getApplicationContext(),NgoHomeActivity.class));
                    finish();
...
///////////when internet is  inactive/////////////////
    ...
    public void ngoresiter(View view) {
        startActivity(new Intent(LoginActivity.this, NgoRegisterActivity.class));
        finish();
    }
}