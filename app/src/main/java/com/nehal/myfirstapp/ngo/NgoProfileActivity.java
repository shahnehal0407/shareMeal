...
//        bottomNavigation.add(new MeowBottomNavigation.Model(ID_ACCOUNT,R.drawable.ic_address));
        ...
        bottomNavigation.setOnClickMenuListener(new MeowBottomNavigation.ClickListener() {
            ...
            public void onClickItem(MeowBottomNavigation.Model item) {
                ...
                switch (item.getId()) {
                    case ID_HOME:
                        startActivity(new Intent(NgoProfileActivity.this, NgoHomeActivity.class));
                        finish();
                        break;
//                        bottomNavigation.setClickable(false);
                }
//                Toast.makeText(NgoHomeActivity.this,"clicked bitch"+item.getId(),Toast.LENGTH_SHORT).show();
            }
        });
...
//        bottomNavigation.setCount(ID_NOTIFICATION,"4");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.getText().toString().isEmpty() || email.getText().
                    ...
                    Toast.makeText(NgoProfileActivity.this,
                ...
                user.updateEmail(profile_email).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        docRef.update(edited).addOnSuccessListener(new
                                                                           OnSuccessListener<Void>() {
                                                                               @Override
                                                                               public void onSuccess(Void unused) {
                                                                                   Toast.makeText(NgoProfileActivity.this,"ProfileUpdated", Toast.LENGTH_SHORT).show();
                                                                                   progressBar.setVisibility(View.INVISIBLE);
                                                                               }
                                                                           });
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(NgoProfileActivity.this, e.getMessage(),
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                user.updatePassword(newPassword).
                                    ...
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(NgoProfileActivity.
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(NgoProfileActivity.this,
                Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(NgoProfileActivity.
                ...
                ActivityCompat.requestPermissions(NgoProfileActivity.this,
    ...
    private void UploadToDatabase(Uri imageUri) {
        ...
        StorageReference fileRef = storageReference.child("users/" + FirebaseAuth.
                getInstance().getCurrentUser().getUid() + "/Ngoprofile.jpg");
