...
public class UploadActivity extends AppCompatActivity {
    ...
    TextView namedetail,iddetail,ngoid;
...
//                    Log.d("TAG","nameisbro" + key);
                    ...
                    StorageReference fileupload = storageReference.child("NgoCompleDonations").child(userID).child(key).child(fileName);
                    int finalI = i;
...
//            }
    ...
    private void StoreLink(String url) {
        databaseReference.child(key).orderByChild("ngoid").equalTo(userID);
